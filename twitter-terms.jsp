...
<%
  String username,l_ID; 
  try{
    username = (String)session.getAttribute("username"); 
    l_ID = (String)session.getAttribute("login_ID"); 
  }
  catch(Exception e){
...
<meta content="2867234365" name="session-userid" />
<meta content="milichab" name="session-user-screen_name" />
    <title id="page_title">Twitter / Twitter Terms of Service</title>
    <link href="/oexchange.xrd" rel="http://oexchange.org/spec/0.8/rel/related-target" type="application/xrd+xml" />
    

    <link href="https://abs.twimg.com/a/1419377433/stylesheets/twitter.css?1420662177" media="screen" rel="stylesheet" type="text/css" />
<link href="https://abs.twimg.com/a/1419377433/stylesheets/geo.css?1420662177" media="screen" rel="stylesheet" type="text/css" />
<link href="https://abs.twimg.com/a/1419377433/stylesheets/buttons_new.css?1420662177" media="screen" rel="stylesheet" type="text/css" />
    <link href="https://abs.twimg.com/a/1419377433/stylesheets/layout_newtwitter.css?1420662177" media="screen" rel="stylesheet" type="text/css" />
    
    <link href="https://abs.twimg.com/a/1419377433/stylesheets/sprites.css?1420662177" media="screen" rel="stylesheet" type="text/css" />
    
        <style type="text/css">
      
        body { background: #C0DEED url('https://abs.twimg.com/a/1419377433/images/bg-clouds.png') repeat-x; }
      
      
      
    </style>

      <link href="https://abs.twimg.com/a/1419377433/stylesheets/internal.css?1420662177" media="screen, projection" rel="stylesheet" type="text/css" />
  <link href="https://abs.twimg.com/a/1419377433/stylesheets/terms.css?1420662177" media="screen, projection" rel="stylesheet" type="text/css" />

  </head>

  <body class="help chrome" id="tos">    <div id="top-stuff">
      <div id="banners" style="clear: both;">
        ...
        <link href="https://abs.twimg.com/a/1419377433/stylesheets/layout_newtwitter_topbar.css?1420662177" media="screen" rel="stylesheet" type="text/css" />
...
<div class="topbar" id="corpBar">
  ...
  <div class="topbar-inner">
    <div class="fixed-container clearfix">
        ...
        <a class="bird-corpbar" href="https://twitter.com/" title="Twitter / Home" accesskey="1">
          <i class="bird-topbar-white"></i>
        </a>
      

      <form method="post" id="sign_out_form" action="logout.jsp" style="display:none;">
        <input name="authenticity_token" value="237457ea0446e64f4e307872da06f0304dbd1147" type="hidden"/>
      </form>

      <ul class="nav secondary-nav">
        <li class="account">
                <a class="menu user-photo" href="twitter-home.jsp?login_ID=<%=l_ID%>">
        <img alt="Default_profile_2_mini" height="24" src="https://abs.twimg.com/sticky/default_profile_images/default_profile_2_mini.png" width="24" />
        <span class="menu-label screen-name"><%=username%> </span>
      </a>

          <ul class="menu-dropdown">
            <li><a href="twitter-settings.jsp?login_ID=<%=l_ID%>" accesskey="s" id="settings_link">Settings</a></li>
            <li><a href="/logout" accesskey="l" id="sign_out_link" onclick="document.getElementById('sign_out_form').submit(); return false;">Sign out</a></li>
                    </ul>
        </li>
      </ul>
  ...
  <li><a href="#footer" accesskey="2">Skip to navigation</a></li>
    ...
    <div id="container">
            <span id="loader" style="display:none"><img alt="Loader" src="https://abs.twimg.com/a/1419377433/images/loader.gif" /></span>
...
<p>These Terms of Service ("<strong>Terms</strong>") govern your access to and use of the services, including our various websites, SMS, APIs, email notifications, applications, buttons, widgets, ads, and commerce services  (the "<strong>Services</strong>" or “<strong>Twitter</strong>”), and any information, text, graphics, photos or other materials uploaded, downloaded or appearing on the Services (collectively referred to as "<strong>Content</strong>"). Your access to and use of the Services are conditioned on your acceptance of and compliance with these Terms. By accessing or using the Services you agree to be bound by these Terms.
</p>

<h3>1. Basic Terms</h3>

<p>You are responsible for your use of the Services, for any Content you post to the Services, and for any consequences thereof. The Content you submit, post, or display will be able to be viewed by other users of the Services and through third party services and websites (go to the <a href="/settings/security">account settings</a> page to control who sees your Content). You should only provide Content that you are comfortable sharing with others under these Terms.</p>

<p class="tip"><span class="tip">Tip</span> What you say on Twitter may be viewed all around the world instantly.  You are what you Tweet!</p>
...
<p class="tip"><span class="tip">Tip</span> You can opt-out of most communications from Twitter including our newsletter, new follower emails, etc. Please see the <a href="/settings/notifications">Notifications</a> tab of Settings for more.</p>
...
<p class="tip"><span class="tip">Tip</span> This license is you authorizing us to make your Tweets available to the rest of the world and to let others do the same.</p>
...
<p class="tip"><span class="tip">Tip</span> Twitter does not disclose personally identifying information to third parties except in accordance with our <a href="/privacy">Privacy Policy</a>.</p>
...
<p class="tip"><span class="tip">Tip</span> We encourage and permit broad re-use of Content. The Twitter API exists to enable this.</p>

<p>If you use commerce features of the Services that require credit or debit card information, such as our Buy Now feature, you agree to our <a href="https://support.twitter.com/articles/20171943">Twitter Commerce Terms</a>.</p>
...
<p>Nothing in this section shall affect Twitter’s rights to change, limit or stop the provision of the Services without prior notice, as provided above in section 1.</p>

<h3>11.Disclaimers and Limitations of Liability</h3>

<p>Please read this section carefully since it limits the liability of Twitter and its parents, subsidiaries, affiliates, related companies, officers, directors, employees, agents, representatives, partners, and licensors (collectively, the “Twitter Entities”).  Each of the subsections below only applies up to the maximum extent permitted under applicable law.  Some jurisdictions do not allow the disclaimer of implied warranties or the limitation of liability in contracts, and as a result the contents of this section may not apply to you.  Nothing in this section is intended to limit any rights you may have which may not be lawfully limited.</p>
...
<p><em>Effective: January 8, 2015</em></p>
...
<script src="https://abs.twimg.com/a/1419377433/javascripts/twitter-https.js" type="text/javascript"></script>
<script src="https://abs.twimg.com/a/1419377433/javascripts/lib/jquery.tipsy.min.js?1420662177" type="text/javascript"></script>
  <script src="https://abs.twimg.com/a/1419377433/javascripts/layout_newtwitter.js?1420662177" type="text/javascript"></script>
<script type="text/javascript">
//<![CDATA[
      page.controller_name = 'HelpController';
      page.action_name = 'tos';
      twttr.form_authenticity_token = '237457ea0446e64f4e307872da06f0304dbd1147';
      $.ajaxSetup({ data: { authenticity_token: '237457ea0446e64f4e307872da06f0304dbd1147' } });
